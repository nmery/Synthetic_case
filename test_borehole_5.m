function [be,bt,osrt,osre,ke,be_cr,bt_cr,osrt_cr,osre_cr,ke_cr,stat,zv,ze,ze_cr]=test_borehole_5(n,modelg,cg,model,c,lse,m,mp,yz,lc,lsi,cas)
...
for i=1:n
    ...
    bh1x4=(-lsi+lse).*rand(1,1)-lse;
    bh1y4=(lse-lsi).*rand(1,1)+lsi;
    bh1x5=(-lsi+lse).*rand(1,1)-lse;
    bh1y5=(lse-lsi).*rand(1,1)+lsi;
    ...
    bh2x4=(lse-lsi).*rand(1,1)+lsi;
    bh2y4=(lse-lsi).*rand(1,1)+lsi;
    bh2x5=(lse-lsi).*rand(1,1)+lsi;
    bh2y5=(lse-lsi).*rand(1,1)+lsi;
    ...
    bh3x4=(-lsi+lse).*rand(1,1)-lse;
    bh3y4=(-lsi+lse).*rand(1,1)-lse;
    bh3x5=(-lsi+lse).*rand(1,1)-lse;
    bh3y5=(-lsi+lse).*rand(1,1)-lse;
    ...
    bh4x4=(lse-lsi).*rand(1,1)+lsi;
    bh4y4=(-lsi+lse).*rand(1,1)-lse;
    bh4x5=(lse-lsi).*rand(1,1)+lsi;
    bh4y5=(-lsi+lse).*rand(1,1)-lse;
    ...
    bh13=[[bh1x4;bh1x4;bh1x4],[bh1y4;bh1y4;bh1y4],bh1z'];
    bh14=[[bh2x4;bh2x4;bh2x4],[bh2y4;bh2y4;bh2y4],bh2z'];
    bh15=[[bh3x4;bh3x4;bh3x4],[bh3y4;bh3y4;bh3y4],bh3z'];
    bh16=[[bh4x4;bh4x4;bh4x4],[bh4y4;bh4y4;bh4y4],bh4z'];
    bh17=[[bh1x5;bh1x5;bh1x5],[bh1y5;bh1y5;bh1y5],bh1z'];
    bh18=[[bh2x5;bh2x5;bh2x5],[bh2y5;bh2y5;bh2y5],bh2z'];
    bh19=[[bh3x5;bh3x5;bh3x5],[bh3y5;bh3y5;bh3y5],bh3z'];
    bh20=[[bh4x5;bh4x5;bh4x5],[bh4y5;bh4y5;bh4y5],bh4z'];
    x2=[bh1;bh5;bh9;bh13;bh17;bh2;bh6;bh10;bh14;bh18;bh3;bh7;bh11;bh15;bh19;bh4;bh8;bh12;bh16;bh20];
    ...
    if mp==1 % 1 borehole
        x=x2(id0(1:3),:);
    elseif mp==2 % 2 boreholes
        x=x2(id0(1:6),:);
    elseif mp==3 % 3 boreholes
        x=x2(id0(1:9),:);
    elseif mp==4 % 1 borehole per quadrant
        x=[x21(id1(1:3),:);x22(id2(1:3),:);x23(id3(1:3),:);x24(id4(1:3),:)];
    elseif mp==5 % 2 boreholes per quadrant
        x=[x21(id1(1:6),:);x22(id2(1:6),:);x23(id3(1:6),:);x24(id4(1:6),:)];
    elseif mp==6 % 3 boreholes per quadrant
        x=[x21(id1(1:9),:);x22(id2(1:9),:);x23(id3(1:9),:);x24(id4(1:9),:)];
    end
...
ke_cr=nanmean(KE_cr);
osre_cr=100*((nanvar(zv(index))-nanvar(ze_cr(index)))/nanvar(zv(index)));
